    ...
    <nav class="navbar navbar-dropdown transparent navbar-fixed-top bg-color">
        ...
        <div class="container">
            ...
            <ul class="nav-dropdown collapse pull-xs-right navbar-toggleable-sm nav navbar-nav" id="exCollapsingNavbar">
                ...
                <a class="nav-link link dropdown-toggle" data-toggle="dropdown-submenu" href="#" aria-expanded="false">Daftar</a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="register01.php">Pemilik</a>
                        <a class="dropdown-item" href="register02.php">Penyewa</a>
